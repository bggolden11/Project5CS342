    ...
    public void send(Serializable data) throws Exception {
       // connthread.out.writeObject(data);
        if(isServer() && clientOnethere && clientTwothere)
        {
            ...
            t.out.writeObject("Player 1 score is " + scorePlayer1 + " Player two score is " + scorePlayer2);
            if(scorePlayer2 ==3)
            {
                t.out.writeObject("Game over player 2 wins");
                scorePlayer1 =0;
                scorePlayer2 =0;
            }
            else if(scorePlayer1 ==3)
            {
                t.out.writeObject("Game over player 1 wins");
                scorePlayer2 =0;
                scorePlayer1 =0;
            }
                clientOnethere=false;
                clientTwothere = false;
